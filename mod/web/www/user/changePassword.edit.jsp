...
$(function() {
	...
	formChangePass.opts.onAjaxSubmitSuccess = function() {
		dlg.dialog('close');
		$("#saveSuccess").show().delay(2500).fadeOut("fast");
	};
	...
	<j:form>
		<form id="changePass" action="changePassword.save" method="post" autocomplete="off">
			<div class="form">
				...
				<div class="frow">
					<label class="g5" for="changePass_currentPassword">Password:</label>
					<input type="password" name="currentPassword" id="changePass_currentPassword" class="g7" maxlength="25"/>
					<div class="error error_msg pre5" id="changePass_currentPassword_error"></div>
				</div>
				<div class="frow">
