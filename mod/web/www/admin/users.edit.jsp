...
$(function() {
	...
	<j:ifelse test="${empty user.email}">
		<j:then>
			dlg.dialog('option', 'title',  'New user');
		</j:then>
		<j:else>
...
<div style="text-align:left;">
	<j:form>
		<form id="save" action="users.save" method="post" autocomplete="off">
			<div class="form">
				...
				<div class="frow">
					...
					<div class="g7">
						<label class="g4" for="save_user_level_user">user</label>
						<input type="radio" value="1" id="save_user_level_user" name="user.level" checked="checked"/>
						<label class="g4" for="save_user_level_admin">administrator</label>
						<input type="radio" value="100" id="save_user_level_admin" name="user.level"/>
					</div>
				</div>
